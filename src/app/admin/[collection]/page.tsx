...
> = {
  members: {
    ...
    fields: [
      ...
      { label: "N° adhésion", path: "membershipNumber", type: "text", table: true },
      { label: "Dernière connexion", path: "auth.lastLoginAt", type: "datetime", table: true },
  ...
  products: {
    ...
    fields: [
      ...
      { label: "Quantité max", path: "saleLimit", type: "number", table: true },
    ],
  },
  catalogues: {
    title: "Catégories",
