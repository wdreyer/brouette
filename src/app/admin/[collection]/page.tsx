...
> = {
  members: {
    ...
    fields: [
      ...
      { label: "Nom du compte", path: "accountLabel", type: "text", table: true },
      { label: "Compte partage", path: "sharedAccountEnabled", type: "boolean", table: true },
      { label: "Email 2", path: "secondaryEmail", type: "text" },
      { label: "Telephone 2", path: "secondaryPhone", type: "text" },
