...
export default function ProductPage() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      let openOffers: Array<VisibleOffer<OfferItem>> = [];
      if (openDist) {
        ...
        const producerLinks: ProducerLinkLike[] = producerLinkSnap.docs.map((producerDoc) => ({
          id: producerDoc.id,
      ...
      openOffers
        ...
        .forEach((offer) => {
          ...
          if (!variantId) return;
          const saleKey = offer.resolvedSaleDateKey;
          if (saleKey) {
